...
-(void)setBackgroundColorOfCanvas:(UIColor *)backgroundColorOfCanvas{
    self.backgroundColor = backgroundColorOfCanvas;
}
...
-(void)createContentOfScrollView{
    ...
    for (int i = 0; i < self.textArray.count; i++) {
        ...
        self.contentSize = CGSizeMake(self.contentSize.width+CGRectGetWidth(textLabel.frame), self.bounds.size.height);
